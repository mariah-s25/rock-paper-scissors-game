...
if(count > 9){
  ...
  localStorage.setItem("secScore",0);
  localStorage.setItem("count",0);
...
if(!secScore){
  ...
  document.getElementById("secScore").innerHTML = score2;
}
...
function play2(player2) {
  ...
  (player1 == 'scissors' && player2 == 'paper')
    ...
    result = "Player2 Wins!";
    secScore++;
    localStorage.setItem("secScore",secScore);
  }   
