...
function play(playerWeapon){
  ...
  localStorage.setItem("playerSvg", playerSvg);
  localStorage.setItem("houseSvg", houseSvg);
  localStorage.setItem("playerClass", playerClass);
  localStorage.setItem("houseClass", houseClass);
